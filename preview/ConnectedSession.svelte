...
{#if development}
  <div class="runtime-shell">
    {#snippet chat()}<ConnectedChat agent={development.agent} onChange={()=>canvasRevision++} onBack={()=>development=null} />{/snippet}
    {#snippet canvas()}<ConnectedCanvas revision={canvasRevision} />{/snippet}
