...
export const stateDirectory = process.env.EMAIL_CAMPAIGN_PREVIEW_STATE_DIRECTORY ?? fileURLToPath(new URL('../.bot-local/email-campaign', import.meta.url));
export async function prepareLocalState() {
  if (!process.env.EMAIL_CAMPAIGN_PREVIEW_STATE_DIRECTORY)
